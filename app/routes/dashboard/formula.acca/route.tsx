...
export const meta: MetaFunction = mergeMeta(() => {
  return [{ title: "Gerar Conteúdo com a Fórmula ACCA" }]
})

export const loader = async ({ params }: LoaderFunctionArgs) => {
  let feature = await getFeatureByKeyname("ACCA")
  feature = feature[0]
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  console.log("generating content with formula ACCA")
  ...
  const command = new StartExecutionCommand({
    ...
    input: JSON.stringify({
      event_type: "process-copywriting-acca",
...
const schema = z.object({
  ...
  problem: z.string().min(8, "A ação deve ter pelo menos 8 caracteres"),
  agitate: z.string().min(8, "O resultado deve ter pelo menos 8 caracteres"),
  solution: z.string().min(8, "O resultado deve ter pelo menos 8 caracteres"),
})
          ...
          <div className="mt-10 w-full sm:mx-auto">
            <Form className="h-full w-full" method="post" {...form.props}>
              ...
              <div className="isolate mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-7xl lg:grid-cols-1">
                <div className="w-full space-y-6">
                  ...
                  <div>
                    <Label htmlFor="description">
                      Descreva o que sua empresa faz (em 5 a 6 palavras)
                    </Label>
                    <div className="mt-2">
                      <Input
                        ...
                        id="description"
                        type="text"
                        placeholder="Ferramentas de escrita de IA"
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      <Label htmlFor="problem">
                        Que problema seu público enfrenta?
                      </Label>
                    </div>
                    <div className="mt-2">
                      <Input
                        ...
                        id="problem"
                        type="text"
                        placeholder="Lutando para gerenciar finanças"
                ...
                <div className="w-full space-y-6">
                  <div>
                    <Label htmlFor="agitate">
                      Por que esse problema é sério para o seu público?
                    </Label>
                    <div className="mt-2">
                      <Input
                        error={agitate.error}
                        id="agitate"
                        type="text"
                        placeholder="Leva à instabilidade financeira"
                  ...
                  <div>
                    <Label htmlFor="solution">
                      Como seu produto/serviço resolve esse problema?
                    </Label>
                    <div className="mt-2">
                      <Input
                        ...
                        id="solution"
                        type="text"
                        placeholder="Fornece ferramentas de orçamento fáceis de usar"
