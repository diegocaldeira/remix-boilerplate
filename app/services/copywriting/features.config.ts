...
export const DEFAULT_FEATURES: {
  ...
  [FEATURE_TYPES.STAR]: {
    ...
    example:
      "<b>Exemplo Simples de uma Fórmula de Redação STAR</b>: <ul class='mt-4'><li><b>Situação:</b> Em um ambiente de negócios acelerado...</li> <li><b>Tarefa:</b> Nossa equipe precisava de uma solução para agilizar a comunicação...</li><li> <b>Ação:</b> Implementamos uma nova ferramenta de colaboração... <b>Resultado:</b> Resultando em maior produtividade e eficiência.</li>",
    isActive: true,
    listOfFeatures: [],
    createdAt: new Date(),
    updatedAt: new Date(),
